...
inf = datetime.strptime(sys.argv[3] , "%Y-%m-%dT%H:%M")
sup = datetime.strptime(sys.argv[4] , "%Y-%m-%dT%H:%M")
...
plt.title('Availabe places : '+str(indmaxi[1])+'/'+str(indmaxi[0])+'/2017',fontsize=14)
